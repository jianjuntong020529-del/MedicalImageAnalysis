...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.title.setMinimumSize(QtCore.QSize(200, 20))
        self.title.setMaximumSize(QtCore.QSize(240, 20))
        ...
        self.pushButton_loadSegmentationResult.setFont(self.font)
        ...
        self.tool_bar_layout.addWidget(self.pushButton_loadSegmentationResult, Qt.AlignBottom)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_loadSegmentationResult.setText(_translate("MainWindow", "Load Segmentation Result"))
    ...
    def segmentation(self):
        ...
        info.show()
        Step1_CBCT_ToothAlveolar_Seg(input_cbct_file_path,input_landmark_textfile_path,getSubjectName(),self.output_file_path,self.flag_seg,self.threshold_th,
                                     self.threshold_al,self.smoothfactor,self.erosion_radius_up,self.erosion_radius_low)
        info.exec_()
    ...
    def load_segmentation_result(self):
        ...
        self.child_window = UI_ReadSegmentationResult()
        self.child_window.show()
        self.child_window.LoadSTL()
...
class UI_ReadSegmentationResult(QWidget):
    def __init__(self):
        ...
        _translate = QtCore.QCoreApplication.translate
        self.setWindowTitle(_translate("Widget", "Segmenation Result"))

    def LoadSTL(self):
        print("subject_name: "+getSubjectName())
        datanames = os.listdir("./output")
        for dataname in datanames:
            if os.path.splitext(dataname)[1] == '.stl':
                list = dataname.split("_")
                if len(list) > 2 and list[0] == getSubjectName():
